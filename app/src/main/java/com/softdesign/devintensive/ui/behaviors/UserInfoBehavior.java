...
public class UserInfoBehavior<V extends LinearLayout> extends AppBarLayout.ScrollingViewBehavior {
    ...
    public UserInfoBehavior(Context context, AttributeSet attrs) {
        ...
        mMaxAppbarHeight = context.getResources().getDimensionPixelOffset(R.dimen.profile_img_size); //256dp
        mMaxUserInfoHeight = context.getResources().getDimensionPixelOffset(R.dimen.user_info_header); //112dp
    }
