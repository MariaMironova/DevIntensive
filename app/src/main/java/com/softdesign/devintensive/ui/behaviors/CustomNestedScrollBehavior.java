...
public class CustomNestedScrollBehavior extends AppBarLayout.ScrollingViewBehavior {
    ...
    public CustomNestedScrollBehavior(Context context, AttributeSet attrs) {
        ...
        mMaxAppbarHeight = context.getResources().getDimensionPixelSize(R.dimen.profile_img_size);
        mMaxUserInfoHeight = context.getResources().getDimensionPixelSize(R.dimen.user_info_header);
    }
